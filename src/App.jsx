    ...
    <section className="panel homepage-panel">
      ...
      <div className="home-priority-grid">
        ...
        <div className="home-priority-card recommended">
          ...
          <strong>{recommendation?.lecture?.title || 'No urgent task'}</strong>
          <small>{recommendation ? `${recommendation.task.label} · ${recommendation.reason}` : 'Everything currently looks caught up.'}</small>
        </div>
      </div>
